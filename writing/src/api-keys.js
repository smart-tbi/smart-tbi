 ...
 * - TextGears API: https://www.textgears.com/
 */

export const TEXTGEAR_API_KEY = "INSERT_YOUR_TEXTGEAR_API_KEY_HERE";
export const PERSPECTIVE_API_KEY = "INSERT_YOUR_PERSPECTIVE_API_KEY_HERE";